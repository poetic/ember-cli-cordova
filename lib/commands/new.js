...
module.exports = Command.extend({
  ...
  run: function() {
    ...
    var tasks = [
      ...
      require('../tasks/update-env-config')(config),
      require('../tasks/copy-ember-cli-modules')('adapters', config),
      require('../tasks/copy-ember-cli-modules')('components', config),
      require('../tasks/copy-ember-cli-modules')('controllers', config),
      require('../tasks/copy-ember-cli-modules')('routes', config),
      require('../tasks/copy-ember-cli-modules')('styles', config),
      require('../tasks/copy-ember-cli-modules')('templates', config),
      require('../tasks/copy-ember-cli-modules')('views', config)
    ];
